...
namespace ui {
    ...
    namespace util {
        ...
        */
        ...
        auto ApplyTransformMatrix(entt::registry &registry, entt::entity entity, std::shared_ptr<layer::Layer> layerPtr, std::optional<Vector2> addedOffset = std::nullopt, bool applyOnlyTranslation = false) -> void;
