...
# Sprite automation (Aseprite → TexturePacker)
...
The watcher monitors `assets/auto_export_assets.aseprite` and automatically runs `just update-sprites` when the file is saved.
...
- Hidden layers are included (use `--all-layers`)
