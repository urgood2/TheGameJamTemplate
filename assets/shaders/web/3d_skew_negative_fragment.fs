...
vec4 applyOverlay(vec2 atlasUV) {
    ...
    // Apply card rotation so the negative pattern responds to the card's visual orientation
    ...
    float fac = 0.8 + 0.9 * sin(11.0 * rotated_uv.x + 4.32 * rotated_uv.y + negative.x * 12.0 + cos(negative.x * 5.3 + rotated_uv.y * 4.2 - rotated_uv.x * 4.0));
    float fac2 = 0.5 + 0.5 * sin(8.0 * rotated_uv.x + 2.32 * rotated_uv.y + negative.x * 5.0 - cos(negative.x * 2.3 + rotated_uv.x * 8.2));
    float fac3 = 0.5 + 0.5 * sin(10.0 * rotated_uv.x + 5.32 * rotated_uv.y + negative.x * 6.111 + sin(negative.x * 5.3 + rotated_uv.y * 3.2));
    float fac4 = 0.5 + 0.5 * sin(3.0 * rotated_uv.x + 2.32 * rotated_uv.y + negative.x * 8.111 + sin(negative.x * 1.3 + rotated_uv.y * 11.2));
    float fac5 = sin(0.9 * 16.0 * rotated_uv.x + 5.32 * rotated_uv.y + negative.x * 12.0 + cos(negative.x * 5.3 + rotated_uv.y * 4.2 - rotated_uv.x * 4.0));
