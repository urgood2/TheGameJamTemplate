...
local function init_static_defaults()
    ...
    set("fireworks", "TimeStep", 3)
    set("fireworks", "s77", 1.13)
    set("fireworks", "Range", 1.14)
    set("fireworks", "s55", 1.51)
    set("fireworks", "gravity", -0.49)
    set("fireworks", "ShneyMagnitude", 0.42)
    set("fireworks", "s33", 4.15)
    set("fireworks", "iTime", 373.62292)
    set("fireworks", "s99", 9.92)
    set("fireworks", "s11", 0.40)
    set("fireworks", "speed", 5.57)
