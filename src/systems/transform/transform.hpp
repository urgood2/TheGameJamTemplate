...
namespace transform
{
    ...
    struct GameObject
    {
        ...
        std::function<void(std::shared_ptr<layer::Layer>, entt::registry &, entt::entity)> drawFunction; // called every frame on top of the object's own draw method (so object's own draw method executes, then this one)
