...
constexpr size_t MAX_TEXTURES = 100;  // Maximum number of textures
extern Texture2D spine_textures[MAX_TEXTURES]; // Declare the array
...
extern void engine_drawMesh(Vertex* vertices, unsigned short* indices, size_t numIndices, Texture2D texture, spine::BlendMode blendMode, bool isXScaleNegative, bool isYScaleNegative);
...
extern spine::Vector<Vertex> vertices;
...
extern void drawSkeleton(spine::Skeleton &skeleton);



// auto drawSkeleton(spSkeleton *skeleton, Vector3 position, bool PMA) -> void {
