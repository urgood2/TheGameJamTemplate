    ...
    update = function(e, dt) -- update can be coroutine
        ...
        while true do
            ...
            if absYDiff < globals.defaultColonistMoveSpeed and absXDiff < globals.defaultColonistMoveSpeed then
                ...
                break -- exit the loop if the entity is close enough to the target location 
            else 
                ...
                log_debug("Entity", e, "is wandering towards", goalLoc, "at position", Vec2(transformComp.actualX, transformComp.actualY))
