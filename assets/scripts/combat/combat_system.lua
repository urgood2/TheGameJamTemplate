...
Effects.deal_damage = function(p)
  return function(ctx, src, tgt)
    ...
    if defensive_mark_result and defensive_mark_result.effects and #defensive_mark_result.effects > 0 then
    ...
    if defensive_mark_result and defensive_mark_result.reflect and defensive_mark_result.reflect > 0 and src then
