...
particle.ParticleRenderType = {
    ...
    ELLIPSE_STRETCH = 7,  -- Draw an ellipse stretched along the particle’s velocity vector.
    LINE_FACING = 8,  -- Draws a line segment oriented along the velocity vector (optionally face-locked).
    ELLIPSE = 5,  -- Draw a filled ellipse (oval).
    LINE = 6,  -- Draw a straight line segment from (0,0) to (w,h).
    TEXTURE = 0,  -- Use a sprite texture
    RECTANGLE_LINE = 1,  -- Draw a rectangle outline
    RECTANGLE_FILLED = 2,  -- Draw a filled rectangle
    CIRCLE_LINE = 3,  -- Draw a circle outline
...
---
--- Root table for game layers and their components.
---
---@class layers
layers = {
    ui = Layer,  -- Layer for ui elements.
    sprites = Layer,  -- Layer for sprites elements.
    final = Layer,  -- Layer for final elements.
    background = Layer  -- Layer for background elements.
}
...
---
--- Loads a named font at multiple sizes for the multi-size font cache.
---
---@param name string # The name to register the font under (e.g., 'tooltip').
---@param path string # The file path to the font file (TTF/OTF).
---@param sizes table # Array of font sizes to load (e.g., {16, 22, 24, 32}).
---@param defaultSize number # The default font size.
---@return nil
function localization.loadNamedFontSizes(...) end
...
---
--- Gets the best font for the requested size from a named font, preferring downscaling from larger sizes.
---
...
function localization.getBestFontForSize(...) end
...
function localization.getBestFontSizeFor(...) end

---
--- Gets the best font for the requested size from the current language font, preferring downscaling from larger sizes.
---
---@param requestedSize number # The requested font size.
---@return Font # The best matching font for the requested size from the current language font.
function localization.getBestLangFontForSize(...) end
