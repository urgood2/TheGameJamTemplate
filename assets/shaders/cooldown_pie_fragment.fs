...
// Top-down fill cooldown overlay for trigger cards
// Shows progress as vertical fill from top, darkening the "on cooldown" portion
#version 330 core
...
uniform vec2 uImageSize;          // Atlas dimensions in pixels
uniform vec4 uGridRect;           // x, y, width, height in pixels
