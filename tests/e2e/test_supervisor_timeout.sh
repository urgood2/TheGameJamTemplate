...
dump_path="${work_dir}/forensics/hang_dump.json"
export E2E_SUPERVISOR_DUMP_PATH="${dump_path}"

set +e
"${supervisor_bin}" run --timeout-seconds 1 --dump-grace-seconds 1 -- \
  "${stub_bin}" --sleep-ms 3000 --stderr "timeout" \
