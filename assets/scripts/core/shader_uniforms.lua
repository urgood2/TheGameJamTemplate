...
local function init_static_defaults()
    ...
    set("3d_skew", "outline_thickness", 1.0)
    ...
    set("3d_skew_holo", "x_rot", 0.0)
    set("3d_skew_holo", "y_rot", 0.0)
    set("3d_skew_holo", "inset", 0.0)
    set("3d_skew_holo", "hovering", 0.3)
    set("3d_skew_holo", "rand_trans_power", 0.4)
    set("3d_skew_holo", "rand_seed", 3.1415)
    set("3d_skew_holo", "rotation", 0.0)
    set("3d_skew_holo", "cull_back", 0.0)
    set("3d_skew_holo", "tilt_enabled", 0.0)
    set("3d_skew_holo", "regionRate", Vector2{ x = 1.0, y = 1.0 })
    set("3d_skew_holo", "pivot", Vector2{ x = 0.0, y = 0.0 })
    set("3d_skew_holo", "quad_center", Vector2{ x = 0.0, y = 0.0 })
    set("3d_skew_holo", "quad_size", Vector2{ x = 1.0, y = 1.0 })
    set("3d_skew_holo", "uv_passthrough", 0.0)
    set("3d_skew_holo", "uGridRect", Vector4{ x = 0.0, y = 0.0, z = 1.0, w = 1.0 })
    set("3d_skew_holo", "uImageSize", Vector2{ x = VIRTUAL_W, y = VIRTUAL_H })
    set("3d_skew_holo", "texture_details", Vector4{ x = 0.0, y = 0.0, z = 64.0, w = 64.0 })
    set("3d_skew_holo", "image_details", Vector2{ x = 65.15, y = 64.0 })
    set("3d_skew_holo", "dissolve", 0.0)
    set("3d_skew_holo", "shadow", 0.0)
    set("3d_skew_holo", "burn_colour_1", Vector4{ x = 0.0, y = 0.0, z = 0.0, w = 0.0 })
    set("3d_skew_holo", "burn_colour_2", Vector4{ x = 0.0, y = 0.0, z = 0.0, w = 0.0 })
    set("3d_skew_holo", "card_rotation", 0.0)
    set("3d_skew_holo", "material_tint", Vector3{ x = 1.0, y = 1.0, z = 1.0 })
    set("3d_skew_holo", "grain_intensity", -1.95)
    set("3d_skew_holo", "grain_scale", -2.21)
    set("3d_skew_holo", "sheen_strength", -1.49)
    set("3d_skew_holo", "sheen_width", 2.22)
    set("3d_skew_holo", "sheen_speed", 2.3)
    set("3d_skew_holo", "noise_amount", 1.12)
    set("3d_skew_holo", "spread_strength", 1.0)
    set("3d_skew_holo", "distortion_strength", 0.05)
    ...
    set("3d_skew_voucher", "x_rot", 0.0)
    set("3d_skew_voucher", "y_rot", 0.0)
    set("3d_skew_voucher", "inset", 0.0)
    set("3d_skew_voucher", "hovering", 0.3)
    set("3d_skew_voucher", "rand_trans_power", 0.4)
    set("3d_skew_voucher", "rand_seed", 3.1415)
    set("3d_skew_voucher", "rotation", 0.0)
    set("3d_skew_voucher", "cull_back", 0.0)
    set("3d_skew_voucher", "tilt_enabled", 0.0)
    set("3d_skew_voucher", "regionRate", Vector2{ x = 1.0, y = 1.0 })
    set("3d_skew_voucher", "pivot", Vector2{ x = 0.0, y = 0.0 })
    set("3d_skew_voucher", "quad_center", Vector2{ x = 0.0, y = 0.0 })
    set("3d_skew_voucher", "quad_size", Vector2{ x = 1.0, y = 1.0 })
    set("3d_skew_voucher", "uv_passthrough", 0.0)
    set("3d_skew_voucher", "uGridRect", Vector4{ x = 0.0, y = 0.0, z = 1.0, w = 1.0 })
    set("3d_skew_voucher", "uImageSize", Vector2{ x = VIRTUAL_W, y = VIRTUAL_H })
    set("3d_skew_voucher", "texture_details", Vector4{ x = 0.0, y = 0.0, z = 64.0, w = 64.0 })
    set("3d_skew_voucher", "image_details", Vector2{ x = 65.15, y = 64.0 })
    set("3d_skew_voucher", "dissolve", 0.0)
    set("3d_skew_voucher", "shadow", 0.0)
    set("3d_skew_voucher", "burn_colour_1", Vector4{ x = 0.0, y = 0.0, z = 0.0, w = 0.0 })
    set("3d_skew_voucher", "burn_colour_2", Vector4{ x = 0.0, y = 0.0, z = 0.0, w = 0.0 })
    set("3d_skew_voucher", "card_rotation", 0.0)
    set("3d_skew_voucher", "material_tint", Vector3{ x = 1.0, y = 1.0, z = 1.0 })
    set("3d_skew_voucher", "grain_intensity", -1.95)
    set("3d_skew_voucher", "grain_scale", -2.21)
    set("3d_skew_voucher", "sheen_strength", -1.49)
    set("3d_skew_voucher", "sheen_width", 2.22)
    set("3d_skew_voucher", "sheen_speed", 2.3)
    set("3d_skew_voucher", "noise_amount", 1.12)
    set("3d_skew_voucher", "spread_strength", 1.0)
    set("3d_skew_voucher", "distortion_strength", 0.05)
    ...
    set("3d_skew_gold_seal", "x_rot", 0.0)
    set("3d_skew_gold_seal", "y_rot", 0.0)
    set("3d_skew_gold_seal", "inset", 0.0)
    set("3d_skew_gold_seal", "hovering", 0.3)
    set("3d_skew_gold_seal", "rand_trans_power", 0.4)
    set("3d_skew_gold_seal", "rand_seed", 3.1415)
    set("3d_skew_gold_seal", "rotation", 0.0)
    set("3d_skew_gold_seal", "cull_back", 0.0)
    set("3d_skew_gold_seal", "tilt_enabled", 0.0)
    set("3d_skew_gold_seal", "regionRate", Vector2{ x = 1.0, y = 1.0 })
    set("3d_skew_gold_seal", "pivot", Vector2{ x = 0.0, y = 0.0 })
    set("3d_skew_gold_seal", "quad_center", Vector2{ x = 0.0, y = 0.0 })
    set("3d_skew_gold_seal", "quad_size", Vector2{ x = 1.0, y = 1.0 })
    set("3d_skew_gold_seal", "uv_passthrough", 0.0)
    set("3d_skew_gold_seal", "uGridRect", Vector4{ x = 0.0, y = 0.0, z = 1.0, w = 1.0 })
    set("3d_skew_gold_seal", "uImageSize", Vector2{ x = VIRTUAL_W, y = VIRTUAL_H })
    set("3d_skew_gold_seal", "texture_details", Vector4{ x = 0.0, y = 0.0, z = 64.0, w = 64.0 })
    set("3d_skew_gold_seal", "image_details", Vector2{ x = 65.15, y = 64.0 })
    set("3d_skew_gold_seal", "dissolve", 0.0)
    set("3d_skew_gold_seal", "shadow", 0.0)
    set("3d_skew_gold_seal", "burn_colour_1", Vector4{ x = 0.0, y = 0.0, z = 0.0, w = 0.0 })
    set("3d_skew_gold_seal", "burn_colour_2", Vector4{ x = 0.0, y = 0.0, z = 0.0, w = 0.0 })
    set("3d_skew_gold_seal", "card_rotation", 0.0)
    set("3d_skew_gold_seal", "material_tint", Vector3{ x = 1.0, y = 1.0, z = 1.0 })
    set("3d_skew_gold_seal", "grain_intensity", -1.95)
    set("3d_skew_gold_seal", "grain_scale", -2.21)
    set("3d_skew_gold_seal", "sheen_strength", -1.49)
    set("3d_skew_gold_seal", "sheen_width", 2.22)
    set("3d_skew_gold_seal", "sheen_speed", 2.3)
    set("3d_skew_gold_seal", "noise_amount", 1.12)
    set("3d_skew_gold_seal", "spread_strength", 1.0)
    set("3d_skew_gold_seal", "distortion_strength", 0.05)
    ...
    local function set_pseudo_3d_skew_defaults(name, effect_uniform, effect_value)
        ...
        set(name, "y_rot", 0.0)
        set(name, "inset", 0.0)
        set(name, "hovering", 0.3)
        set(name, "rand_trans_power", 0.4)
        set(name, "rand_seed", 3.1415)
        set(name, "rotation", 0.0)
        set(name, "cull_back", 0.0)
        set(name, "tilt_enabled", 0.0)
        set(name, "regionRate", Vector2{ x = 1.0, y = 1.0 })
        set(name, "pivot", Vector2{ x = 0.0, y = 0.0 })
        set(name, "quad_center", Vector2{ x = 0.0, y = 0.0 })
        set(name, "quad_size", Vector2{ x = 1.0, y = 1.0 })
        set(name, "uv_passthrough", 0.0)
        set(name, "uGridRect", Vector4{ x = 0.0, y = 0.0, z = 1.0, w = 1.0 })
        set(name, "uImageSize", Vector2{ x = VIRTUAL_W, y = VIRTUAL_H })
        set(name, "texture_details", Vector4{ x = 0.0, y = 0.0, z = 64.0, w = 64.0 })
        set(name, "image_details", Vector2{ x = 65.15, y = 64.0 })
        set(name, "dissolve", 0.0)
        set(name, "shadow", 0.0)
        set(name, "burn_colour_1", Vector4{ x = 0.0, y = 0.0, z = 0.0, w = 0.0 })
        set(name, "burn_colour_2", Vector4{ x = 0.0, y = 0.0, z = 0.0, w = 0.0 })
        set(name, "card_rotation", 0.0)
        set(name, "material_tint", Vector3{ x = 1.0, y = 1.0, z = 1.0 })
        set(name, "grain_intensity", -1.95)
        set(name, "grain_scale", -2.21)
        set(name, "sheen_strength", -1.49)
        set(name, "sheen_width", 2.22)
        set(name, "sheen_speed", 2.3)
        set(name, "noise_amount", 1.12)
        set(name, "spread_strength", 1.0)
        set(name, "distortion_strength", 0.05)
        set(name, "fade_start", 0.7)

        if effect_uniform then
    ...
    set_pseudo_3d_skew_defaults("3d_skew_aurora", "aurora")
    set_pseudo_3d_skew_defaults("3d_skew_iridescent", "iridescent")
    set_pseudo_3d_skew_defaults("3d_skew_nebula", "nebula")
