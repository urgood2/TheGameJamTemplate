...
uniform vec3 foilcolor = vec3(1.0);
uniform float threshold = 0.1;
uniform float fuzziness = 0.1;
uniform float period = 1.0;
uniform float scroll = 1.0;
uniform float normal_strength = 0.1;
uniform float effect_alpha_mult = 1.0;
uniform float direction = 0.5;
