...
namespace ImGui
{
    ...
    IMGUI_API bool          Begin(const char* name, bool* p_open = NULL, ImGuiWindowFlags flags = 0, std::optional<std::function<void()>> callback = std::nullopt);
    IMGUI_API void          End();
