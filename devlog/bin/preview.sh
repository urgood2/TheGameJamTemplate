...
# Usage: preview.sh <manifest.json>
# Opens Remotion Studio for preview/fine-tuning before render
...
# Create a props file for Remotion Studio
PROPS_FILE="devlog/remotion/public/assets/${POST_NAME}/props.json"
...
echo ""
echo "  📺 Preview and adjust timings in the browser"
echo "  🎬 When satisfied, close Studio and run:"
echo "     ./devlog/bin/render.sh $MANIFEST"
echo ""

cd devlog/remotion

# Start Remotion Studio with the props
npx remotion studio --props="public/assets/${POST_NAME}/props.json"
